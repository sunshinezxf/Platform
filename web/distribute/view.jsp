...
<script type="text/javascript">
    ...
    wx.ready(function () {
        ...
        wx.onMenuShareAppMessage({
            ...
            success: function () {
                useroperation("${vo.article.articleId}", WgateJs.getWgateid(), "分享给朋友", "success");
            },
            cancel: function () {
                useroperation("${vo.article.articleId}", WgateJs.getWgateid(), "分享给朋友", "cancel");
            }
        });
        ...
        wx.onMenuShareTimeline({
            ...
            success: function (res) {
                useroperation("${vo.article.articleId}", WgateJs.getWgateid(), "分享到朋友圈", "success");
            },
            cancel: function (res) {
                useroperation("${vo.article.articleId}", WgateJs.getWgateid(), "分享到朋友圈", "cancel");
            },
            fail: function (res) {
                useroperation("${vo.article.articleId}", WgateJs.getWgateid(), "分享到朋友圈", "fail");
            }
        });
    });
</script>
